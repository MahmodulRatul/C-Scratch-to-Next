//C program that checks an input is a keyword or not.
#include <stdbool.h>
#include <stdio.h>
#include <string.h>
...
bool isKeyword(char* str)
{
    if (!strcmp(str, "auto") || !strcmp(str, "default") || !strcmp(str, "signed") || !strcmp(str, "enum")
        ...
        || !strcmp(str, "else") || !strcmp(str, "elseif")  || !strcmp(str, "int") || !strcmp(str, "while") || !strcmp(str, "do")
...
int main()
{
    ...
    scanf("%s",&x);
    isKeyword(&x) ? printf("\nYes input '%s' is a keyword \n",&x) : printf("\nNo input '%s' is not a keyword \n",&x);
    return 0;
}
